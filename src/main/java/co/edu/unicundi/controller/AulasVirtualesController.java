...
public class AulasVirtualesController {
	...
	@ApiOperation(value="Metodo que retorna aulas viertuales por su id")
	public ResponseEntity<?> retornarId(@PathVariable int id) throws ModelNotFoundException, Exception  {
		AulasVirtuales au = service.buscarId(id);
		return new ResponseEntity<AulasVirtuales>(au, HttpStatus.OK);	
